    ...
    <div className='min-h-screen'>
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <p className='text-gray-500 text-xs sm:text-sm'>Here you'll find a variety of articles and tutorials on topics
          such a web development,software engineering, and programming languages.
        </p>
        <Link to='search' className='text-xs sm:text-sm text-teal-500 fond-bold hover:underline'>View all posts</Link>
      </div>
