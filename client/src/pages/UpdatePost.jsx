    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
            <div className="flex flex-col gap-4 sm:flex-row justify-between">
                <TextInput value={formData.title} onChange={(e)=>setFormData({...formData,title:e.target.value})} type='text' placeholder='Title'  id='title' className='flex-1'/>
            ...
            <ReactQuill value={formData.content} onChange={(value)=>{setFormData({...formData,content:value})}} theme='snow' placeholder='Write your post here' className='h-72 mb-12'/>
