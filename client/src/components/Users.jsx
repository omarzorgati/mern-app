              ...
              <Table.Body key={user._id} className='divide-y'>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                 ...
                 {user.username}
                  ...
                  <Table.Cell>{user.isAdmin ? <FaCheck className='text-blue-500'/> :<FaTimes className='text-red-500'/>}</Table.Cell>
                  <Table.Cell>
                    <Button onClick={()=>{setShowModal(true);setUserIdToDelete(user._id)}} color='failure'>Delete</Button>
                  </Table.Cell>
                </Table.Row>
              </Table.Body>
            ))}
