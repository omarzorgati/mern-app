...
export default function CartPost({post}) {
  return (
    <div className="group relative w-full border border-teal-500 hover:border-2 h-[400px] sm:w-[420px] 
    overflow-hidden rounded-lg transition-all ">
        <Link to={`/post/${post.slug}`}>
            <img src={post.image} alt="post cover" className="w-full h-[260px] object-cover group-hover:h-[200px] 
